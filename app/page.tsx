    ...
    <>
      ...
      <section id="hero" className="relative overflow-hidden pt-12 pb-20">
        ...
        <div className="container mx-auto px-6 max-w-[1200px] grid md:grid-cols-[1.4fr_1fr] gap-12 items-center">
          <div>
            <span className="inline-block text-xs font-semibold tracking-[0.14em] uppercase bg-primary-soft text-primary px-3 py-1.5 rounded-full mb-5">
      ...
      <section id="introducao" className="py-20">
        <div className="container mx-auto px-6 max-w-[860px]">
          <span className="eyebrow">01 · Introdução</span>
          ...
          <div className="bg-accent-soft border-l-4 border-accent p-5 rounded-r mt-6">
      ...
      <section id="metodologia" className="py-20 bg-white border-y border-line">
        <div className="container mx-auto px-6 max-w-[860px]">
          <span className="eyebrow">02 · Metodologia</span>
      ...
      <section id="estatisticas" className="py-20">
        <div className="container mx-auto px-6 max-w-[1200px]">
          <span className="eyebrow">03 · Resultados</span>
          ...
          <div className="border border-line rounded-[14px] overflow-hidden bg-white shadow-sm overflow-x-auto">
            <table className="w-full min-w-[640px] border-collapse">
              <thead>
                <tr>
                  <th className="px-4 py-3.5 text-[11px] tracking-wider uppercase font-semibold bg-primary-soft text-primary text-left">Estatística</th>
                  {grupos.map((g) => (
                    <th key={g.id} className="px-4 py-3.5 text-[11px] tracking-wider uppercase font-semibold bg-primary-soft text-primary text-center">
                      {g.label}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {[
                  ...
                  <tr key={label} className={i % 2 === 0 ? "bg-white" : "bg-[#fbfcfe]"}>
                    <th className="px-4 py-3 text-left font-semibold text-ink-2 border-t border-line text-sm">{label}</th>
                    {grupos.map((g) => (
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-9">
            {[
              { icon: "📉", title: "Mediana sempre baixa", desc: "Em três dos quatro cenários, a mediana é inferior a 1,0 — sinal de que metade dos alunos não atinge esse limiar." },
              { icon: "📊", title: "Alta dispersão", desc: "Desvios padrão entre 2,7 e 3,0 revelam que, embora poucos alunos se destaquem, a maioria concentra-se nas faixas mais baixas." },
              { icon: "⚖️", title: "VGA levemente melhor", desc: "Em ambas as turmas, VGA apresenta médias e medianas superiores às de Cálculo I, indicando diferenças de aproveitamento." },
            ].map((k) => (
              <article key={k.title} className="bg-white border border-line rounded-[14px] p-6 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
                <span className="text-2xl block mb-2">{k.icon}</span>
                <h3 className="text-lg font-semibold mb-2">{k.title}</h3>
                <p className="text-muted m-0 text-sm">{k.desc}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section id="distribuicao" className="py-20 bg-white border-y border-line">
        <div className="container mx-auto px-6 max-w-[1200px]">
          <span className="eyebrow">04 · Visualizações</span>
      ...
      <section id="aprovacao" className="py-20">
        <div className="container mx-auto px-6 max-w-[1200px]">
          <span className="eyebrow">05 · Indicador crítico</span>
          ...
          <div className="mt-5 flex items-center gap-4 bg-accent-soft border border-[#ffd9c8] rounded-[14px] p-4">
        ...
        <div className="container mx-auto px-6 max-w-[1200px]">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <article className="bg-white border border-line rounded-[14px] p-6 shadow-sm relative overflow-hidden">
              ...
              <header className="flex items-center gap-2 mb-3"><span className="text-xl">🔍</span><h3 className="text-lg font-semibold m-0">Diagnóstico</h3></header>
            ...
            <article className="bg-white border border-line rounded-[14px] p-6 shadow-sm relative overflow-hidden">
              ...
              <header className="flex items-center gap-2 mb-3"><span className="text-xl">🎯</span><h3 className="text-lg font-semibold m-0">Ação</h3></header>
              <p className="text-muted m-0">
      ...
      {/* ============== FOOTER ============== */}
      <footer className="bg-ink-2 text-[#c8d3e6] py-9 text-sm">
        <div className="container mx-auto px-6 max-w-[1200px] flex items-start justify-between flex-wrap gap-8">
          <div>
            ...
            <small className="text-[#8c9bb6]">Análise de Desempenho Acadêmico em Cálculo I e VGA</small>
          </div>
          <div className="max-w-[540px]">
            <span className="text-accent font-semibold">Referência: </span>
            <em className="not-italic text-[#c8d3e6] italic">{meta.referencia}</em>
          </div>
        </div>
      </footer>
    </>
